...
<%-- => [글저장]을 클릭한 경우 게시글 저장 처리 페이지(board_write_action.jsp)로 이동 - 입력값 전달 --%>
...
<%
	...
	// 부모글의 전달값을 반환받아 저장
	if(request.getParameter("ref")!=null){ // 전달값이 있는 경우
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="secret" value="1"> 비밀글
					<%-- 체크하면 값이 전달되지만 그렇지 않으면 전달되지 않는다. --%>
			</td>	
		</tr>
		<tr>
			<th>내용</th>
