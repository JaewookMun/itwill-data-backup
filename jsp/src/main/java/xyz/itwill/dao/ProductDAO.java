...
public class ProductDAO extends JdbcDAO {
	...
	// 카테고리를 전달받아 PRODUCT 테이블에 저장도니 해당 카테고리의 제품정보를 검색하여 반환하는 메소드
	...
	public int insertProduct(ProductDTO product) {
		...
		try {
			...
			close(con, pstmt);
				...
				// 제품코드가 식별자 역할을 할 수 있지만 좀 더 쉽게 전달하기 위해 제품번호 사용
				// 검색속도의 경우 문자보다 숫자가 훨씬 더 빠르다.
		return rows;
	}
	...
	// 제품정보를 전달받아 PRODUCT 테이블에 저장된 해당 제품정보의 제품정보를 삭제하고 
	// 삭제행의 갯수를 반환하는 메소드
