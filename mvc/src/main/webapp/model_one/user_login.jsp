...
<%-- [로그인]을 클릭한 경우 로그인 처리페이지(user_login_action.jsp)로 이동 - 인증정보 전달 --%>
<%-- 로그인 사용자 : 환영메세지를 전달하는 기능 제공 --%>
<%-- => [회원목록]을 클릭한 경우 회원목록 출력페이지(user_list.jsp)로 이동 --%>
<%-- => [회원등록]을 클릭한 경우 회원정보 입력페이지(user_write.jsp)로 이동 - 관리자만 가능 - --%>
