...
<%-- 회원정보를 검색하여 클라이언트에게 전달하는 JSP 문서 --%>
<%-- => [수정]을 클릭한 경우 회원정보 변경 입력페이지(modifyForm.do)로 이동 - 아이디 전달 : 관리자만 요청 가능 --%>
<%-- => [삭제]을 클릭한 경우 회원정보 삭제 처리페이지(remove.do)로 이동 - 아이디 전달 : 관리자만 요청 가능 --%>
<%-- => [목록]을 클릭한 경우 회원정보 출력페이지(list.do)로 이동 - 아이디 전달 --%>
	...
	<tr>
	  ...
	  <table border="0" cellpadding="0" cellspacing="1" width="590" bgcolor="BBBBBB">
		  ...
		  <tr>
			...
			<td width=490 bgcolor="ffffff"  style="padding-left:10px;">
				${userinfo.email }
					<%-- null일 경우 출력이 안되기 때문에 if문을 사용안해도 된다. --%>
			</td>
		  </tr>		  
	  </table>
	  <br>
