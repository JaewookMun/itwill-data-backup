...
public class AjaxCommentDAO extends JdbcDAO {
	...
	// 댓글정보를 전달받아 AJAX_COMMENT 테이블에 삽입하여 저장하고 삽입행의 갯수를 반환하는 메소드
	...
	// 댓글번호를 전달받아 AJAX_COMMENT 테이블에 저장된 해당 댓글정보를 삭제하고 삭제행의 갯수를 반환하는 메소드
	...
	// 댓글번호를 전달받아 AJAX_COMMENT 테이블에 저장된 해당 댓글정보를 검색하여 반환하는 메소드
