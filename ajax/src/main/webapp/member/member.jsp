...
<body>
	...
	/*
	document.getElementById("log").innerHTML+="메세지출력-1<br>";
	document.getElementById("log").innerHTML+="메세지출력-2<br>";
	*/
	...
	function log(message){
		...
		if(logElement!=null){
			logElement.innerHT	L+=message+"<br>";
		}
	}
	*/
	...
	*/
	...
	member.display();	
		...
		// JS로 객체를 생성할 때 - 하나만 생성할 경우 or 여러개 생성할 때
	</script>
</body>
</html>