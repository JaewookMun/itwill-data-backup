...
AJAX 기능으로 요청하여 XML 텍스트 데이터를 응답받아 출력되도록 처리 --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
			...
			if(xhr.status==200){
				...
				if(code=="success"){
					...
					for(i=0; i<suggestArray.length; i++){
						html+="<a href=\"javascript:selectSuggest('"+suggestArray[i].word+"','"+suggestArray[i].url+"');\">"+suggestArray[i].word+"<br>"
					}
