...
<body>
	...
	<table>
		...
		<tr>
			...
			<td align="center">${fileBoard.subject }</td>
			<td align="center">${fileBoard.origin }</td>
			<td align="center">
	...
	<p>
		<button type="button" onclick="location.href='file_upload';">업로드</button>
	</p>
	...
	function fileDelete(num){
		...
		if(confirm("정말로 삭제 하시겠습니까?")) {
			location.href="file_delete/"+num;
				// 식별자를 쿼리스트링으로 전달할 수도 있지만 URL주소로 전달 가능하다.
		}
	}
