...
// 학생정보를 저장하기 위한 클래스 : VO 클래스, DTO 클래스, JavaBean 클래스
	// JavaBean - 웹에서 사용할 떄 부르는 이름
public class Student {
	private int num;
	private String name;
	private String email;
	
		// 필드의 값을 제어할 수 있는 방법은 2가지 - 생성자, Setter || 은닉화설정되어 있다면. 
	...
	public void setNum(int num) {
		this.num = num;
		System.out.println("*** Studnet 클래스의 setNum(int num) 메소드 호출 ***");
	}
	...
	public void setName(String name) {
		this.name = name;
		System.out.println("*** Studnet 클래스의 setName(String name) 메소드 호출 ***");
	}
	...
	public void setEmail(String email) {
		this.email = email;
		System.out.println("*** Studnet 클래스의 setEmail(String email) 메소드 호출 ***");
	}
