...
//학생정보(학번, 이름, 국어, 영어, 총점)를 저장하기 위한 클래스
	//자료형을 선언할 때 연산을 위해선 숫자형 그렇지 않으면 문자열(참조형)
	//검색속도를 위해서 int를 줄 수도 있음.
public class Student {
	...
	//정적 필드(Static Field) : 클래스가 사용시 만들어지는 필드
	...
	public Student(int num, String name, int kor, int eng) {
		...
		//총점을 계산하여 저장하는 명령(이미 메소드존재) >> 메소드 호출
	...
	//정적 메소드(Static Mehtod) : this 매개변수가 없는 메소드
	...
	//총점을 계산하는 메소드 - 시스템 메소드 : 클래스 내부에서만 호출되는 메소드
	/*
