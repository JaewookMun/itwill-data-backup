...
public class StudentGUIApp extends JFrame implements ActionListener {
	...
	public void displayAllStudent() {
		// STUDENT Å×ÀÌºí¿¡ ÀúÀåµÈ ¸ğµç ÇĞ»ıÁ¤º¸¸¦ °Ë»öÇÏ¿© ¹İÈ¯ÇÏ´Â DAO Å¬·¡½ºÀÇ ¸Ş¼Òµå È£Ãâ
			// application¿¡¼­´Â DB¿¡ ¿¬µ¿ÇÏÁö ¾Ê´Â´Ù.
		List<StudentDTO> studentList = StudentDAO.getDAO().selectAllStudentList();
			// ½Ì±ÛÅÏÆĞÅÏÀÇ ÀÎ½ºÅÏ½º´Â ÂüÁ¶º¯¼ö¿¡ ÀúÀåÇÏÁö ¾Ê´Â´Ù. - ºÒÇÊ¿äÇÑ ÂüÁ¶º¯¼ö¸¦ ¸¸µå´Â °ÍÀº ±ÇÀåÇÏÁö ¾Ê´Â´Ù.
		...
		for(StudentDTO student : studentList) {
			...
			Vector<Object> rowData=new Vector<Object>();
				// µğÆúÆ®Å×ÀÌºí¸ğµ¨¿¡ ÇàÀ» »ğÀÔÇÒ ¶§ ÀÏ¹İ ¹è¿­À» »ç¿ëÇØµµ µÇÁö¸¸ Vector¸¦ »ç¿ëÇØµµ µÈ´Ù.
	...
	// => ÀÌº¥Æ® ÇÚµé·¯ ¸Ş¼Òµå¿¡¼­ [ADD]»óÅÂ¿¡¼­ [Ãß°¡]¹öÆ°À» ´©¸¥ °æ¿ì È£Ãâ
		// ÀÔ·Â°ªÀÌ Çü½Ä¿¡ ¸Â°Ô ÀÔ·ÂµÆÀ» ¶§¸¸ Ã³¸®µÉ ¼ö ÀÖµµ·Ï °ËÁõÀÛ¾÷À» ÁøÇà.
		// ÀÔ·Â°ª¿¡ ´ëÇÑ °ËÁõÀ» ÅëÇØ Á¤»óÀûÀÎ °ªÀ» ¹Ş´Â °ÍÀÌ Áß¿äÇÏ´Ù.
	public void addStudent() {
		...
		if(!Pattern.matches(noReg, noTemp)) {// Á¤±ÔÇ¥Çö½Ä°ú ÀÔ·Â°ªÀÇ Çü½ÄÀÌ ´Ù¸¥ °æ¿ì
			JOptionPane.showMessageDialog(this, "ÇĞ¹øÀ» 4ÀÚ¸®ÀÇ ¼ıÀÚ·Î¸¸ ÀÔ·ÂÇØ ÁÖ¼¼¿ä.");
			noTF.requestFocus();//ÀÔ·ÂÃĞÁ¡À» ÀÌµ¿ÇÏ´Â ¸Ş¼Òµå
			return;
		}
		...
		// ÇĞ¹øÀ» Àü´ŞÇÏ¿© STUDENT Å×ÀÌºí¿¡ ÀúÀåµÈ ÇĞ»ıÁ¤º¸¸¦ °Ë»öÇÏ´Â DAO Å¬·¡½ºÀÇ ¸Ş¼Òµå È£Ãâ
		...
		if(phone.equals("")) {//ÀÔ·Â°ªÀÌ ¾ø´Â °æ¿ì
			JOptionPane.showMessageDialog(this, "ÀüÈ­¹øÈ£À» ¹İµå½Ã ÀÔ·ÂÇØ ÁÖ¼¼¿ä");
	...
	public void removeStudent() {
		...
		// ÇĞ¹øÀ» Àü´ŞÇÏ¿© STUDENT Å×ÀÌºí¿¡¼­ ÇØ´ç ÇĞ¹øÀÇ ÇĞ»ıÁ¤º¸¸¦ »èÁ¦ÇÏ´Â DAO Å¬·¡½ºÀÇ
	...
	public void searchNoStudent() {
		...
		if(student==null) {// °Ë»öµÇ¾î ¹İÈ¯µÈ ÇĞ»ıÁ¤º¸°¡ ¾ø´Â °æ¿ì
			...
			noTF.requestFocus();// ÀÔ·ÂÃĞÁ¡À» ÀÌµ¿ÇÏ´Â ¸Ş¼Òµå
			noTF.setText("");// JTextFeild ÄÄÆÛ³ÍÆ® ÃÊ±âÈ­
			return;
		}
	...
	public void modifyStudent() {
		...
		JOptionPane.showMessageDialog(this, rows+"¸íÀÇ ÇĞ»ıÁ¤º¸¸¦ º¯°æÇÏ¿´½À´Ï´Ù.");
	...
	// => ÀÌº¥Æ® ÇÚµé·¯ ¸Ş¼Òµå¿¡¼­ [SEARCH]»óÅÂ¿¡¼­ [º¯°æ]¹öÆ°À» ´©¸¥ °æ¿ì È£Ãâ 
