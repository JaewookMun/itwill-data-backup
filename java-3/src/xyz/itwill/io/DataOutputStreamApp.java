...
public class DataOutputStreamApp {
	public static void main(String[] args) throws IOException {
		...
		//DataOutputStream : OutputStream 인스턴스를 전달받아 원하는 자료형의 값을 원시
		//데이터로 변환하여 전달하는 기능을 제공하는 출력 스트림을 생성하기 위한 확장 클래스
		...
		//DataOutputStream.writeBoolean(boolean b) : 논리값을 출력 스트림으로 전달하는 메소드
		...
		System.out.println("c:\\data\\data.txt 파일에 다양한 자료형의 값들을 저장 하였습니다.");
