...
public class ValidationApp {
	public static void main(String[] args) {
		...
		*/
		...
		//=> false : 불일치 , true : 일치
			//CharSequence : String이라고 생각하면 된다.
		...
		*/
		...
		//=> 정규 표현식과 문자열을 비교하는 기능 외 변경 또는 삭제 처리하는 기능 제공
		...
		//비교하여 결과를 반환하는 메소드 - false : 불일치, true : 일치
		...
		*/
		...
		//비밀번호 규칙 - 영문자,숫자,특수문자를 반드시 1개이상 포함하여 8~30 범위의 문자로 표현
