...
//=> 동일한 값의 요소 중복 저장 가능
	//ArrayList, Vector는 메소드가 거의 유사한데 Vector는 동기화 처리된 메소드가 많음. 
	//다중스레드를 이용할 때 Vector 권장, 아닐 때는 ArrayList. 
	//web application에서 다중스레드는 DB연동 (DB자체적으로 동기화 처리되기 떄문에) ArrayList사용 
...
public class ListApp {
	public static void main(String[] args) {
		...
		System.out.println("list = "+list);
		System.out.println("====================================================================================");
		//List.size() : List 인스턴스에 저장된 요소의 갯수를 반환하는 메소드
		...
		//List.set(int index, E element) : List 인스턴스에 저장된 요소 중 원하는 위치의
		//요소를 변경하는 메소드
		list.set(1, "임걱정");
		System.out.println("list = "+list);
		System.out.println("====================================================================================");
