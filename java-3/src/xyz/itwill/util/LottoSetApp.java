...
//1~45 범위의 중복되지 않는 정수난수 6개를 제공받아 오름차순 정렬하여 출력하는 프로그램을 작성
public class LottoSetApp {
	public static void main(String[] args) {
		...
		//Set.toArray(E[] a) : Set 인스턴스를 배열로 변환하여 반환하는 메소드
			//toArray() 괄호에 넣는 요소의 갯수는 중요하지 않음 0이여도 괜찮음.
		Integer[] lotto = lottoSet.toArray(new Integer[0]);
		
		//Arrays.sort(Object[] a) : 배열을 전달받아 요소를 정렬하는 메소드
		Arrays.sort(lotto);
		
		//Arrays.toString(Object[] a) : 배열을 전달받아 모든 배열 요소값을 문자열로 변환하는 메소드
