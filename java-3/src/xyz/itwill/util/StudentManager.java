...
public class StudentManager {
	...
	//학생정보를 전달받아 콜렉션 필드의 요소로 추가하고 저장 결과를 반환하는 메소드
	//=> false : 미저장, true : 저장
	//=> 전달받은 학생정보의 학번이 이미 콜렉션필드에 저장된 요소인 경우 저장되지 않도록 처리
		//좀더 고급지게 코드를 작성하려면 boolean 대신 Exception을 넣어 예외를 발생시킬 수도 있다.
	...
	//=> 전달받은 학번이 콜렉션 필드에 저장된 요소가 아닌 경우 null반환
