...
//=> 문자열을 제어할 수 있는 기능 제공 - 저장된 문자열을 변환하는 메소드 미존재 //think: 저장된 문자열을 변경할 수 없다.
//=> 내부적으로 String 인스턴스의 문자열은 byte 배열의 요소에 문자로 저장되어 처리
public class StringApp {
	public static void main(String[] args) {
		
		//" " 기호를 이용하여 String 인스턴스 표현 가능
		String str1="ABC"; //String 인스턴스를 생성하여 참조변수에 저장
		...
		if(str1==str2) {
			System.out.println("str1과 str2가 같습니다.");
		} else {
			System.out.println("str1과 str2가 다릅니다.");
		}
		System.out.println("====================================================");
		//new 연산자로 생성자를 호출하여 인스턴스를 생성하면 무조건 새로운 인스턴스를 생성
		String str3 = new String("ABC");
		
		//참조변수를 관계연산자로 비교할 경우 참조변수에 저장된 인스턴스(HashCode)를 
		//비교하여 결과 제공
		...
		//false를 반환하고 같으면 true를 반환하는 메소드
			//문자열을 비교할 때 사용 (비교연산자로처리하면 안됨)
		if(str1.equals(str3)) {
			System.out.println("str1과 str2에 저장된 문자열이 같습니다.");
		} else {
			System.out.println("str1과 str2에 저장된 문자열이 다릅니다.");
		}
		System.out.println("====================================================");
		String str4="abc";
		...
		System.out.println("====================================================");
		//String.indexOf(String str) : 전달된 문자열을 검색하여 저장된 위치의 시작첨자를 반환
		//=> 검색 문자열이 없는 경우 -1 반환
		...
		System.out.println("====================================================");
		//String.substring(int beginIndex, int endIndex) : 저장된 문자열에서 시작첨자(문자
